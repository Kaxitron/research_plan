# Lesson 9: Dot Products, Orthogonality, and Projections

[← SVD](lesson-08-svd.md) | [Back to TOC](../README.md) | [Next: Change of Basis and Norms →](lesson-10-change-of-basis.md)
...
1. **3Blue1Brown — "Dot products and duality" (Ch. 9)**
   ...
   - *The insight that a dot product is secretly a 1×n matrix transformation is stunning and ties everything back to Lesson 3. A 1×2 row vector [a, b] acting on a column vector [x, y] gives ax + by — that's a dot product AND a linear transformation from ℝ² to ℝ¹. Duality!*
...
So attention = dot products (this lesson) → softmax → linear combinations (Lesson 2). You now understand every piece.
