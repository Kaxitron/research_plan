---
title: "The Alignment Observatory"
subtitle: "Final Project --- Build, Train, Interpret, and Align"
format:
  pdf:
...
| **Prerequisites** | All lessons (0–99) and all exams completed |
...
2. What is the computational complexity of attention as a function of sequence length n and dimension d? Where does the bottleneck come from? (Lesson 76: computational complexity)
...
- **DPO or simple RLHF:** implement a simplified version of Direct Preference Optimization.
  ...
  - (Lesson 64: LLM pipeline, Lesson 98: alignment problem)
...
3. Could your model have learned to game the reward model rather than genuinely satisfy the criterion? Describe what this would look like and how you'd detect it. (Lesson 98: alignment problem — Goodhart's Law)
...
### Requirements
- **Symmetry analysis:** your model has permutation symmetry in the hidden neurons. Compute the size of the symmetry group for your architecture. Show that permuted weight configurations produce identical outputs. (Lesson 80: groups, Lesson 84: group actions)
...
- **Topological analysis:** compute the persistent homology of the learned representations (activation vectors for a batch of inputs). Compare the topology before and after alignment training (Stage 5). Did alignment change the shape of the representation space? (Lesson 85: point-set topology)
- **Logical limits reflection:** your alignment attempt in Stage 5 tried to verify a behavioral property. Using Rice's theorem (Lesson 74), explain why perfect verification is impossible. Using Löb's theorem (Lesson 79), explain why the model cannot self-certify its own alignment.
...
| **Phase 5** | 74–84 | Stage 6 (symmetry, computability limits) |
| **Phase 5** | 85–89 | Stage 6 (topology, logical limits) |
| **Phase 6** | 95–99 | Stage 5 (alignment), Stage 6 (reflection) |
