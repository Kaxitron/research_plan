...
**The Path to AI Alignment — Lessons 73–79 Comprehensive Assessment**
...
**(c)** Weight space modulo the permutation symmetry S_n (i.e., identifying equivalent weight configurations) is NOT a manifold everywhere — it has singular points. Where do these singularities occur? *(Hint: think about the orbit-stabilizer theorem from Lesson 72.)*
...
**(a)** Permutation symmetry (Lesson 72) → singularity in weight space → blow-up resolution (Lesson 76) → RLCT computation → free energy formula.
