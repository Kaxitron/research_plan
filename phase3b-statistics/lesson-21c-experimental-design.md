# Lesson 21c: Experimental Design and Common Statistical Fallacies

[← Hypothesis Testing](lesson-21b-hypothesis-testing.md) | [Back to TOC](../README.md) | [Next: Regression →](lesson-21d-regression.md)
...
- **Ignoring how common the condition is in the population.** You already know this from Bayes' theorem (Lesson 21), but it's worth seeing the classical version.
