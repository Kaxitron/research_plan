...
- **Population stratification correction** uses PCA on genetic data — the exact eigendecomposition from Lessons 7-8, applied to genetic similarity matrices.
