# Lesson 22: Gradient Flow and Training Dynamics — Training as a River

[← Linear Systems](lesson-21-linear-systems.md) | [Back to TOC](../README.md) | [Next: Stability →](lesson-23-stability.md)
...
- **Fixed points are critical points:** gradient flow stops where ∇L = 0. These are the minima, maxima, and saddle points of L. From Lesson 33, you know that the Hessian eigenvalues at these points determine stability — all positive eigenvalues means a minimum (stable), mixed means a saddle (unstable along some directions).
