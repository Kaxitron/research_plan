...
[← Gradient Flow](lesson-22-gradient-flow.md) | [Back to TOC](../README.md) | [Next: Neural ODEs →](lesson-24-neural-odes.md)
...
- **Singular Learning Theory** (which you'll study in depth in Lesson 51) characterizes phase transitions as changes in the **effective dimensionality** of the model, measured by the RLCT (Real Log Canonical Threshold) λ.
