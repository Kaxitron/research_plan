...
[← Stability](lesson-23-stability.md) | [Back to TOC](../README.md) | [Next: PDEs →](lesson-25-pdes.md)
...
- **"Implicit Regularization in Deep Learning" (survey literature)**
  - The dynamical bias of gradient descent — connects all the pieces from Lessons 32–33
