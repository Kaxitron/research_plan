# Lesson 15b: Constrained Optimization and Lagrange Multipliers

[← Optimization](lesson-15-optimization.md) | [Back to TOC](../README.md) | [Next: Loss Landscapes →](lesson-16-loss-landscapes.md)
...
- **Unconstrained optimization** (Lesson 15): find the lowest point on the entire landscape. Gradient descent walks downhill freely.
...
- **Neural network loss is NOT convex** — it has many local minima and saddle points (Lesson 16). This is why neural network training is fundamentally harder than convex optimization. But understanding convexity tells you when you CAN get guarantees.
