# Lesson 21h: Abstract Algebra — Groups, Symmetry, and Neural Networks

[← Computability](lesson-21g-computability.md) | [Back to TOC](../README.md) | [Next: Topology →](lesson-21i-topology.md)
...
4. **Michael Penn — "Abstract Algebra" playlist (first 5-10 videos)**
...
- **"An Introduction to the Theory of Groups" by Rotman** — Chapter 1–2 (if you want more rigor)
