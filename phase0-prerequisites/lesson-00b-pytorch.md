# Lesson 0b: PyTorch — The Language of Alignment Research

[← Python & NumPy](lesson-00-python-numpy.md) | [Back to TOC](../README.md) | [Next: Vectors →](../phase1-linear-algebra/lesson-01-vectors.md)
...
- **`nn.Linear(in, out)`** is a single matrix multiplication + bias: y = Wx + b. This IS the linear transformation from Lesson 3, packaged as a reusable component.
...
2. **Andrej Karpathy — "Building micrograd"** (first 30 min)
   ...
   - *You'll do this fully in Lesson 15, but the autograd concept preview is useful here.*
