# Lesson 40: Information Theory — Entropy, KL Divergence, Cross-Entropy, and Mutual Information

[← MLE](lesson-39-mle.md) | [Back to TOC](../README.md) | [Next: Hypothesis Testing →](lesson-41-hypothesis-testing.md)
...
- **Cross-entropy** is THE loss function for language modeling. Minimizing cross-entropy = maximizing likelihood (Lesson 17) = minimizing KL divergence from the true distribution. These are all the same optimization.
...
- **Calibration** (Lesson 21) is an information-theoretic property: a well-calibrated model's predicted probabilities are informative about outcome frequencies. This connects to proper scoring rules and cross-entropy loss.
