# Lesson 38: Causal Inference — From Correlation to Causation

[← Bayesian Model Comparison](lesson-37-bayesian-model-comparison.md) | [Back to TOC](../README.md) | [Next: Applied Statistics →](lesson-39-applied-statistics.md)

---

> **Why this lesson exists:** This is arguably the most important lesson in the entire statistics phase. Causal inference is what separates "we observed a correlation" from "X actually causes Y." The techniques here — DAGs, counterfactuals, instrumental variables — give you a rigorous framework for evaluating causal claims. This is directly relevant to alignment (counterfactual reasoning is central to decision theory, Lesson 46) and to the genetics/epidemiology debates you want to adjudicate.
...
- **Decision theory (Lesson 46) IS causal reasoning.** CDT uses causal interventions ("if I do X, what happens?"). EDT uses correlations. FDT uses logical/functional connections. The CDT vs. EDT debate is literally about whether agents should reason causally or evidentially.
