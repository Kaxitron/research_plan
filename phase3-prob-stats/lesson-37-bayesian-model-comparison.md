# Lesson 37: Bayesian Model Comparison and the Free Energy Principle — Occam's Razor from Math

[← Bayesian Computation](lesson-36-bayesian-computation.md) | [Back to TOC](../README.md) | [Next: Causal Inference →](lesson-38-causal-inference.md)
...
- **The variational free energy** (from Lesson 36): F_var = -ELBO = -E_q[log P(D|θ)] + KL(q||prior). This is an upper bound on the true free energy. VI minimizes this bound.
