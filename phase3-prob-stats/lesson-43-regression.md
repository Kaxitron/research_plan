# Lesson 43: Regression — From Linear to Logistic and Beyond

[← Experimental Design](lesson-42-experimental-design.md) | [Back to TOC](../README.md) | [Next: Bayesian Foundations →](lesson-44-bayesian-foundations.md)
...
- **T-tests on coefficients:** "is β₁ significantly different from zero?" This uses the same hypothesis testing framework from Lesson 22. The test statistic is t = β̂₁ / SE(β̂₁).
...
| **p-value** | Significance of this coefficient (see Lesson 22 for caveats) |
...
- **The logistic function:** σ(z) = 1/(1 + e⁻ᶻ) — maps any number to (0, 1). You already know this as the sigmoid from neural networks (Lesson 37).
