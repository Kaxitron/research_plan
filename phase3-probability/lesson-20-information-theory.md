...
- **"Elements of Information Theory" by Cover & Thomas** — Chapters 1-2
  - The standard textbook. Chapters 1-2 cover entropy, mutual information, and the data processing inequality rigorously.
...
- **Cross-entropy** is THE loss function for language modeling. Minimizing cross-entropy = maximizing likelihood (Lesson 19) = minimizing KL divergence from the true distribution. These are all the same optimization.
