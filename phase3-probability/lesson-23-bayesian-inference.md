# Lesson 23: Bayesian Reasoning and Inference

[← Information Theory](lesson-22-information-theory.md) | [Back to TOC](../README.md) | [Next: Hypothesis Testing →](../phase4-statistics/lesson-24-hypothesis-testing.md)
...
- **Interpreting Bayes factors (Jeffreys' scale):**
  ...
  | BF₁₀ | Evidence for H₁ |
  |-------|----------------|
  | 1–4 | Anecdotal / barely worth mentioning |
  | 3–11 | Moderate |
  | 10–46 | Strong |
  | 30–100 | Very strong |
  | > 100 | Decisive |
