# Lesson 24: Hypothesis Testing, P-Values, and What They Actually Mean

[← Bayesian Inference](../phase3-probability/lesson-23-bayesian-inference.md) | [Back to TOC](../README.md) | [Next: Experimental Design →](lesson-25-experimental-design.md)
...
- **The critical distinction:** P(data | H₀) ≠ P(H₀ | data). Confusing these is called the **base rate fallacy** — and you already know from Lesson 23 (Bayes' theorem) that flipping a conditional probability requires the prior. A p-value gives you the likelihood, not the posterior.
