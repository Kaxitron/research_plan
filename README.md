...
> 📊 **NEW: [Interactive Curriculum Dashboard](curriculum-dashboard.html)** — Visual dependency map, time estimates, concept checks, failure mode warnings, and project tracker in one navigable interface. Open this alongside your studies.
