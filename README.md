...
> 📊 **NEW: [Interactive Curriculum Dashboard]([curriculum-dashboard.html](https://kaxitron.github.io/research_plan/curriculum-dashboard.html))** — Visual dependency map, time estimates, concept checks, failure mode warnings, and project tracker in one navigable interface. Open this alongside your studies.
