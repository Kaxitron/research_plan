...
- **colah's blog — "Neural Networks, Manifolds, and Topology"**
  - http://colah.github.io/posts/2014-03-NN-Manifolds-Topology/
  - *The foundation piece connecting topology to deep learning. Assigned since Lesson 18 but NOW you have the vocabulary to fully understand it.*
- **"Topology" by James Munkres** — Chapters 1–4 (topological spaces, connectedness, compactness)
  - *The standard undergraduate topology textbook. Clear, careful, well-motivated. You don't need all of it — Chapters 1-4 give you the core vocabulary.*
