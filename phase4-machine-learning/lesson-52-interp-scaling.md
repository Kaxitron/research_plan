# Lesson 52: Interpretability — Scaling Laws, Emergent Capabilities, and Phase Transitions

[← Interp Circuits](lesson-51-interp-circuits.md) | [Back to TOC](../README.md) | [Next: Interpretability — SLT →](lesson-53-interp-slt.md)
...
- **Connection to Lesson 29:** grokking (sudden generalization after apparent overfitting) is a phase transition during training, not during scaling. It shows that the same sudden-emergence phenomenon happens in the time dimension too.
- **Developmental interpretability** studies these transitions: how do internal representations change at the moment a capability emerges? This connects scaling/emergence to the circuits work in Lesson 45 and to Singular Learning Theory (Lesson 47).
...
1. **Welch Labs — "Why Deep Learning Works Unreasonably Well"**
   ...
   - *Explains why overparameterized models generalize, connecting to double descent (Lesson 29) and scaling.*
...
2. **Andrej Karpathy — "Deep Dive into LLMs" (scaling laws section)**
   ...
   - *Karpathy explains scaling laws with concrete numbers and graphs. If you watched this for Lesson 43, re-watch the scaling section.*
...
- **Plot scaling laws:** find published benchmark results for models of different sizes (GPT-3 124M → 774M → 1.5B, Llama 7B → 13B → 70B). Plot loss vs. parameters on a log-log scale. Verify the power law. Extrapolate: what loss would a 1T parameter model achieve?
...
- **Developmental interpretability** (tracking how capabilities emerge during training) is a direct bridge between scaling/emergence and the circuits work from Lesson 31