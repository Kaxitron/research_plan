# Lesson 28c: Singular Learning Theory — The Geometry of Learning

[← Scaling & Emergence](lesson-28b-scaling-emergence.md) | [Back to TOC](../README.md) | [Next: Game Theory →](../phase6-alignment-theory/lesson-29-game-theory.md)
...
- **Connection to your earlier learning:**
  - **Eigenvalues of the Hessian** (Lessons 7, 12, 16): near-zero eigenvalues indicate flat directions. SLT goes further — it characterizes the geometry when eigenvalues are *exactly* zero.
  - **Rank** (Lesson 5): if the Hessian has rank r < d, there are d-r flat directions. SLT studies the *shape* of the set of parameters where the loss is minimal.
  - **SVD** (Lesson 8): the singular values of related matrices reveal the local geometry.

### Phase Transitions and Developmental Interpretability

- **Phase transitions in training** are moments when the model suddenly learns a new structure — the loss drops sharply, and the internal representations reorganize. Grokking (Lesson 16) is an example.
...
- **Understanding capability emergence:** if capabilities correspond to phase transitions between singularities, SLT gives a mathematical framework for predicting *when* and *how* capabilities emerge. This is the mathematical foundation for the scaling/emergence questions in Lesson 28b.
...
- **Key exercise:** Take the grokking demo from Lesson 16. At the moment of grokking (sudden generalization), what happens to the internal structure? How would you interpret this as a phase transition between singularities?
